...
// Deployed to https://<user>.github.io/auto-repair-demo on GitHub Pages,
...
const nextConfig: NextConfig = {
  output: "export",
  basePath: isGitHubActions ? "/auto-repair-demo" : "",
  assetPrefix: isGitHubActions ? "/auto-repair-demo" : "",
  images: {
  ...
  env: {
    ...
    NEXT_PUBLIC_BASE_PATH: isGitHubActions ? "/auto-repair-demo" : "",
  },
  trailingSlash: true,
};
